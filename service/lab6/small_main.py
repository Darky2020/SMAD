...
interval[0] = round(interval[0], 6)
interval[1] = round(interval[1], 6)
print(f"Інтервальна оцінка для теоретичного коефіцієнта кореляції: \033[96m{interval[0]} <= r <= {interval[1]}\033[0m")
...
if l > r:
    ...
    print(f"\033[92ml < |rₓᵧ*| - кореляційний зв'язок між сумісно виміряними величинами існує\033[0m")
